...
class tracking_reid_result {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new tracking_reid_result(null);
  ...
  static datatype() {
    ...
    return 'grace_attn_msgs/tracking_reid_result';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new tracking_reid_result(null);
...
module.exports = tracking_reid_result;
